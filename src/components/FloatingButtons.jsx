  ...
  return (
    <div className="hidden md:flex fixed bottom-6 right-6 z-[999] flex-col gap-3">
      ...
      <a
        ...
        className="w-14 h-14 rounded-full bg-gradient-to-r from-primary to-primary-dark text-white flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
        aria-label="Call"
      >
