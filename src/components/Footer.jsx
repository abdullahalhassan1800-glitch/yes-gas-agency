    ...
    <footer className="bg-gradient-to-br from-deep-navy via-navy-800 to-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-xs">&copy; {new Date().getFullYear()} Yes Gas Agency. All rights reserved.</p>
          <div className="flex gap-4">
            <a href={`https://wa.me/${siteContent.phoneRaw}`} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary transition-colors">
            ...
            <a href={`tel:+${siteContent.phoneRaw}`} className="text-gray-500 hover:text-primary transition-colors">
